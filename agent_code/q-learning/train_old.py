...
def game_events_occurred(self, old_game_state: dict, self_action: str, new_game_state: dict, events: List[str]):
    ...
    if self.feature == "PreviousWinner":
        old_game_state["remaining_coins"] = self.remaining_coins_old
        coin_diff, killed_opponents_scores = store_unrecoverable_infos_helper(old_game_state, new_game_state)
        self.remaining_coins_old -= coin_diff
        self.killed_opponents_scores.extend(killed_opponents_scores)
        new_game_state["remaining_coins"] = self.remaining_coins_old
